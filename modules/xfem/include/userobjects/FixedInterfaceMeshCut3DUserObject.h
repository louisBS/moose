...
/**
 * FixedInterfaceMeshCut3DUserObject: (1) reads in a mesh describing the fixed interface surface,
 * (2) uses the mesh to do initial cutting of 3D elements
 */

class FixedInterfaceMeshCut3DUserObject : public GeometricCutUserObject
{
public:
  static InputParameters validParams();

  FixedInterfaceMeshCut3DUserObject(const InputParameters & parameters);
