...
#include "FixedInterfaceMeshCut3DUserObject.h"
...
registerMooseObject("XFEMApp", FixedInterfaceMeshCut3DUserObject);

InputParameters
FixedInterfaceMeshCut3DUserObject::validParams()
{
...
FixedInterfaceMeshCut3DUserObject::FixedInterfaceMeshCut3DUserObject(const InputParameters & parameters)
...
void
FixedInterfaceMeshCut3DUserObject::initialSetup()
{
}

void
FixedInterfaceMeshCut3DUserObject::initialize()
{
  ...
  Real velocity = 0.0;//_interface_velocity->computeMovingInterfaceVelocity(2);
  //if (_t_step <= 1)
    //velocity = 0.0;
...
Point
FixedInterfaceMeshCut3DUserObject::findNormalatNode(const Node & node)
{
  Point normal(0.0);
  unsigned num_elem_connect_to_node = 0;
...
bool
FixedInterfaceMeshCut3DUserObject::cutElementByGeometry(const Elem * /*elem*/,
...
bool
FixedInterfaceMeshCut3DUserObject::cutFragmentByGeometry(
...
bool
FixedInterfaceMeshCut3DUserObject::intersectWithEdge(const Point & p1,
                                                const Point & p2,
...
bool
FixedInterfaceMeshCut3DUserObject::isInsideEdge(const Point & p1,
                                           const Point & p2,
                                           const Point & p) const
{
...
Real
FixedInterfaceMeshCut3DUserObject::getRelativePosition(const Point & p1,
                                                  const Point & p2,
                                                  const Point & p) const
{
...
bool
FixedInterfaceMeshCut3DUserObject::isInsideCutPlane(const std::vector<Point> & vertices,
                                               const Point & p) const
{
...
FixedInterfaceMeshCut3DUserObject::getCrackFrontPoints(unsigned int /*num_crack_front_points*/) const
{
