# Input file for an oxide growing outward on top of a steel 21-2N sample in 3D
...
#    variable = C_Mn
#    boundary = right
#    function = derivative_Mn_in_metal
#  [../]
...
[Postprocessors]
  ...
  [./oxide_growth_rate] #[µm/hr]
    type = ScalePostprocessor
    value = derivative_Mn_in_metal #leaving_Mn_flux
